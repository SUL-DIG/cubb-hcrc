...
class CatalogController < ApplicationController  
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field 'keywords', :label => 'Subjects:', :helper_method => :my_helper_method
    ...
    config.add_show_field 'keywords', :label => 'Subjects:', :helper_method => :my_helper_method
