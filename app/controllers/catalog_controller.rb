...
class CatalogController < ApplicationController  
  ...
  configure_blacklight do |config|
    ...
    :grade_level_number_first => { :label => '1st grade', :fq => "grade_level_number:1*"},
    :grade_level_number_second => { :label => '2nd grade', :fq => "grade_level_number:2*"},
    :grade_level_number_third => { :label => '3rd grade', :fq => "grade_level_number:3*"},
    :grade_level_number_fourth => { :label => '4th grade', :fq => "grade_level_number:4*"},
    :grade_level_number_fifth => { :label => '5th grade', :fq => "grade_level_number:5*"},
    :grade_level_number_sixth => { :label => '6th grade', :fq => "grade_level_number:6*"},
    :grade_level_number_seventh => { :label => '7th grade', :fq => "grade_level_number:7*"},
    :grade_level_number_eighth => { :label => '8th grade', :fq => "grade_level_number:8*"},
    :grade_level_number_ninth => { :label => '9th grade', :fq => "grade_level_number:9*"},
    :grade_level_number_tenth => { :label => '10th grade', :fq => "grade_level_number:10*"},
    :grade_level_number_eleventh => { :label => '11th grade', :fq => "grade_level_number:11*"},
    :grade_level_number_twelfth => { :label => '12th grade', :fq => "grade_level_number:12*"},
    ...
    config.add_show_field 'keywords', :label => 'Subjects:'
