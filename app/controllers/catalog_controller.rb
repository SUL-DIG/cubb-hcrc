...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_search_field('corp_author') do |field|
      field.solr_parameters = {
        :'spellcheck.dictionary' => 'corp_author',
        :qf => '${corp_author_qf}',
        :pf => '${corp_author_pf}'
      }
      field.qt = 'search'
    ...
    config.add_sort_field 'relevancy', field: 'score desc, year_sort desc, title_sort asc', :label => 'relevance'
    config.add_sort_field 'year', field: 'year_sort desc, title_sort asc', :label => 'year'
    config.add_sort_field 'author', field: 'author_sort asc, title_sort asc', :label => 'author'
    config.add_sort_field 'title', field: 'title_sort asc, pub_date_sort desc', :label => 'title'
